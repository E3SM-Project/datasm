...
[5](#conda-environments-and-github-repositories)](#conda-environments-and-github-repositories)

[Conda Environments [5](#conda-environments)](#conda-environments)

[“Screen” Session Isolation
[6](#screen-session-isolation)](#screen-session-isolation)

[Github Repositories [7](#github-repositories)](#github-repositories)

[ABOUT DATASM: [8](#about-datasm)](#about-datasm)

[E3SM Domain Knowledge
[9](#e3sm-domain-knowledge)](#e3sm-domain-knowledge)

[The Simulations [9](#the-simulations)](#the-simulations)

[Case IDs and Experiments
[9](#case-ids-and-experiments)](#case-ids-and-experiments)

[The Model Output [10](#the-model-output)](#the-model-output)

[NERSC Long-Term Storage
[10](#nersc-long-term-storage)](#nersc-long-term-storage)

[The DSM Operational Environment
[11](#the-dsm-operational-environment)](#the-dsm-operational-environment)

[Process Automation Support - Maintaining the DSM Infrastructure
[13](#process-automation-support---maintaining-the-dsm-infrastructure)](#process-automation-support---maintaining-the-dsm-infrastructure)

[THE E3SM DATASET_SPEC
[15](#the-e3sm-dataset_spec)](#the-e3sm-dataset_spec)

[The E3SM Archive Map
[21](#the-e3sm-archive-map)](#the-e3sm-archive-map)

[Standard Dataset Extraction Patterns
[22](#standard-dataset-extraction-patterns)](#standard-dataset-extraction-patterns)

[CMIP_CMOR_TABLES [25](#cmip_cmor_tables)](#cmip_cmor_tables)

[THE DSM APPLICATIONS AND TOOLS
[26](#the-dsm-applications-and-tools)](#the-dsm-applications-and-tools)

[DSM Operations [27](#dsm-operations)](#dsm-operations)

[Managing the Production of CMIP Datasets
[27](#managing-the-production-of-cmip-datasets)](#managing-the-production-of-cmip-datasets)

[The LOCK Directory [27](#_Toc216780797)](#_Toc216780797)

[Operational Details: [28](#operational-details)](#operational-details)

[Layout Details: [29](#layout-details)](#layout-details)

[Monitoring Progress and Assessing Completion
[29](#monitoring-progress-and-assessing-completion)](#monitoring-progress-and-assessing-completion)

[Cleanup [30](#cleanup)](#cleanup)

[Managing the Publication of CMIP Datasets
[32](#managing-the-publication-of-cmip-datasets)](#managing-the-publication-of-cmip-datasets)

[Publication Authorization and Late Metadata Updates
[32](#publication-authorization-and-late-metadata-updates)](#publication-authorization-and-late-metadata-updates)

[Maintaining the ESGF Publication Configuration File
[32](#maintaining-the-esgf-publication-configuration-file)](#maintaining-the-esgf-publication-configuration-file)

[Publication Operational Details
[32](#publication-operational-details)](#publication-operational-details)

[The Magical Dataset ID
[36](#the-magical-dataset-id)](#the-magical-dataset-id)

[Dataset Status Files:
[38](#dataset-status-files)](#dataset-status-files)

[Appendix: DSM Tools [40](#appendix-dsm-tools)](#appendix-dsm-tools)

[ALPHABETIC LISTING OF TOOLS:
[41](#alphabetic-listing-of-tools)](#alphabetic-listing-of-tools)

[archive_dataset_extractor.sh:
[41](#archive_dataset_extractor.sh)](#archive_dataset_extractor.sh)

[archive_dataset_extractor.py:
[41](#archive_dataset_extractor.py)](#archive_dataset_extractor.py)

[archive_extraction_service.py:
[41](#archive_extraction_service.py)](#archive_extraction_service.py)

[archive_path_mapper.py
[41](#archive_path_mapper.py)](#archive_path_mapper.py)

[arch_loc_from_arch_map.sh
[41](#arch_loc_from_arch_map.sh)](#arch_loc_from_arch_map.sh)

[datasm_extract_from_archive.sh
[42](#datasm_extract_from_archive.sh)](#datasm_extract_from_archive.sh)

[datasm_pp_sourceroot.sh
[42](#datasm_pp_sourceroot.sh)](#datasm_pp_sourceroot.sh)

[datasm_verify_publication.py
[42](#datasm_verify_publication.py)](#datasm_verify_publication.py)

[df_util.py [43](#df_util.py)](#df_util.py)

[ds_paths_info_dsid_list_compact.sh
[43](#ds_paths_info_dsid_list_compact.sh)](#ds_paths_info_dsid_list_compact.sh)

[ds_paths_info_dsid_list.sh
[43](#ds_paths_info_dsid_list.sh)](#ds_paths_info_dsid_list.sh)

[ds_paths_info.sh [43](#ds_paths_info.sh)](#ds_paths_info.sh)

[dsids_to_archive_map_keys.sh
[43](#dsids_to_archive_map_keys.sh)](#dsids_to_archive_map_keys.sh)

[dsids_to_archive_map_lines.sh
[44](#dsids_to_archive_map_lines.sh)](#dsids_to_archive_map_lines.sh)

[dsm_generate_checksum_manifest.py
[44](#dsm_generate_checksum_manifest.py)](#dsm_generate_checksum_manifest.py)

[dsm_generate_CMIP6.py
[44](#dsm_generate_cmip6.py)](#dsm_generate_cmip6.py)

[dsm_manage_CMIP_production.py
[45](#dsm_manage_cmip_production.py)](#dsm_manage_cmip_production.py)

[dsspec_contract.py [46](#dsspec_contract.py)](#dsspec_contract.py)

[dsspec_expand.py [46](#dsspec_expand.py)](#dsspec_expand.py)

[ensure_status_file_for_dsid.sh
[46](#ensure_status_file_for_dsid.sh)](#ensure_status_file_for_dsid.sh)

[get_e3sm_vars_for_cmip.sh
[46](#get_e3sm_vars_for_cmip.sh)](#get_e3sm_vars_for_cmip.sh)

[latest_data_location_by_dsid.sh
[46](#latest_data_location_by_dsid.sh)](#latest_data_location_by_dsid.sh)

[list_cmip6_dsids.py [47](#list_cmip6_dsids.py)](#list_cmip6_dsids.py)

[list_e3sm_dsids.py [47](#list_e3sm_dsids.py)](#list_e3sm_dsids.py)

[metadata_version.py [47](#metadata_version.py)](#metadata_version.py)

[parent_native_dsid.sh
[47](#parent_native_dsid.sh)](#parent_native_dsid.sh)

[produce_dsid_run_record.sh
[47](#produce_dsid_run_record.sh)](#produce_dsid_run_record.sh)

[report_first_file_for_latest_on_dsid_list.sh
[47](#report_first_file_for_latest_on_dsid_list.sh)](#report_first_file_for_latest_on_dsid_list.sh)

[restart_services.sh [47](#restart_services.sh)](#restart_services.sh)

[rw_yaml.py [47](#rw_yaml.py)](#rw_yaml.py)

[tell_years_dsid.py [48](#tell_years_dsid.py)](#tell_years_dsid.py)

[trisect.py [48](#trisect.py)](#trisect.py)

[Appendix: ESGF Publication Configuration File (Argonne):
[49](#appendix-esgf-publication-configuration-file-argonne)](#appendix-esgf-publication-configuration-file-argonne)
...
codes on various supercomputers, producing output stored in "archives".
The archives must be accessed, and selected subsets of data, referred to
as "datasets", must be extracted, processed, and published.  
...
placed into a "base" environment (usually indicated at the start of your
command-prompt). You should avoid modifying or installing packages in
the base environment, as this is the starting point for environments you
create. By default, environments you create will inherit utilities from
...
The environment configuration file "prod.yml" lists specific versions or
version-ranges for certain utilities needed to support datasm
...
above, but select an environment name like "dsm_test\_\<something\>" to
remind you it is a test environment, "conda activate" that environment,
and then, in your \<git_repo_directory\>, you "cd" into any git-cloned
application package or project directory containing the codes you need
...
responsibility to maintain or update. Those with \[~\] you may be tasked
with assisting, and those with \[-\] just need to be monitored and
re-installed when changes are made by their maintainers.
...
Although there is an associated "datasm" application, it has fallen out
of use, as many of its subordinate functions have been changed,
...
single directory of large tar files (“000000.tar”, “000001.tar”, … ) and
an “index.db” database file that can be queried to identify which tar
files contain dataset files matching a given search pattern. The zstash
tool exploits this feature itself when used to extract selected native
datasets from and archive to the local warehouse directories for CMIP
processing.
...
>
> (Don't forget to "source" your .bashrc, and reactivate your conda env
> if needed.)
...
<figcaption><p>: E3SM CMIP Production Dependencies</p></figcaption>
</figure>
...
<img src="media/image2.png" style="width:4.08814in;height:2.15108in"
alt="Text AI-generated content may be incorrect." />The general
structure is given in the following figure:

<img src="media/image3.png" style="width:4.025in;height:4.67083in"
alt="Text AI-generated content may be incorrect." />**Example of project
CMIP6 tree member:**

**The project E3SM tree:**

<img src="media/image4.png" style="width:5.35556in;height:3.42083in"
alt="Text AI-generated content may be incorrect." />The general
structure is given in the following figure:

<img src="media/image5.png" style="width:5.12691in;height:7.46403in"
alt="Text AI-generated content may be incorrect." />**Example of Project
E3SM tree member (modelVersion 3.0, experiment “historical”):**
...
'1_0', '1_1', '1_1_ECA', '1_2_1', '1_3', '2_0', '2_0_NARRM', '2_1',
'3_0', etc. Given the length of their "resolution" sections, a great
deal of scrolling up and down can be required to locate and edit, copy
or create a new experiment entry under a new branch.
...
A pair of DSM utility tools, "dsspec_contract.py" and "dsspec_expand.py"
can be employed to refactor the "project: E3SM" section of the
dataset_spec, replacing each resolution section with an extension_id
"CASE_EXTENSION_nn", and the original resolution specification is moved
to a new tree named "CASE_EXTENSIONS".

Here is a sample of the same "E3SM: '3_0':" section after contraction:

<img src="media/image6.png" style="width:4.91558in;height:6.97842in"
...
multiple tar-paths within an archive, due to runs that were "broken" by
year-range, and even by the machine upon which partial runs were
...
<span id="_Toc216780797" class="anchor"></span>The LOCK Directory:
...
1.  Attempt to secure the corresponding native data (either locate it in
    the warehouse, or seek to have it retrieved and/or extracted).

2.  Call "\[STAGING_TOOLS\]/dsm_generate_CMIP.py" to:

    1.  Fully determine the required configuration materials (regridding
    ...
    2.  Produce and execute a fully-configured custom python script:

> \<cmip_dataset_id\>.py
>
> that will conduct all necessary operations, to include partitioning
> the native and intermediate input files by "per-decade" subdirectories
> and submitting the required operations in decade-parallel to
> slurm/srun.

3.  Upon completion, move the resulting CMIP datafiles to their
    warehouse location, and collect the run-script and various output
    logs (cmor_logs, e2c_logs, and the dsm_generate log to a
    "RUN_RECORDS/\<dataset_id\>/" directory for forensic examination if
    needed.
...
<img src="media/image7.png" style="width:6.5in;height:4.03264in"
...
- Submission of transfers via "globus_cli" will report "transfer
  submission request successful", but not wait around to tell you if the
  files are actually transferred. (One would need to run a subsequent
  globus_cli test, hours later, to confirm transfer completion).

- The esgpublisher allows you to "successfully publish" (the metadata to
  the index), but has no ability to tell you if the files you state are
  on the data-node are present.

- There is a "verify_publication" utility on hand, but it "verifies" by
  testing if the desired datasets are in the esgf server index tables.
  Again, not a real test.
...
sometimes not "one-to-one" with the native variables and may be defined
in terms of formulas involving multiple native variables. The
...
NOTE: "Table" is often a combo of Realm+Freq (Amon = atmos mon), but not
always.
...
NOTE: These tools are "installed" to /p/user_pub/e3sm/staging/tools, and
many rely upon definition files (Archive_Map, dataset_spec.yam) in
...
Similar to the bash script "archive_dataset_extractor.sh". Use "--help"
for details
...
Runs much as a background daemon to service "extraction request tickets"
placed in
...
fund lists of pattern-matched files. A body of preliminary "Archive_Map"
lines are generated, each of which must be reviewed and manually
completed in order to upda the Archive_Map.
...
frequency) are lost. Good for the setup of "zstash holodeck" symlinks in
the manual exploration of archives.

### datasm_extract_from_archive.sh

datasm_extract_from_archive.sh \<file of native dataset_ids\>

This script will create "archive extraction request tickets" that can be
read by the "archive_extraction_service" to pull datasets from archive
to warehouse.
...
"/p/user_pub/e3sm/warehouse" or "/p/user_pub/work", whichever has the
latest data. This utility is a "temporary fix" for some datasm operation
command-line elements, to override the "smart but incorrect" internal
behavior regarding the desired source and destination of generated data.
...
if \[-u \| --update-status\] is specified, the corresponding status file
for the given dataset if updated to reflect this status, unless the
...
1.  Print the full path to the dataset's ststus file, if it exists.

2.  Print the last status value in the status file, if it exists.

3.  Print the full path to warehouse ensemble directory, and below it
    the list of versions and their file counts.

4.  Print the full path to publication ensemble directory, and below it
    the list of versions and their file counts.
...
If "--dryrun" is given, the subordinate python run-script is created but
not executed.
...
"LOCK-yyyymmdd" will be created in your current working directory (with
yyyymmdd being the current UTC date), and all operations for this run
(aside from some reporting) will be conducted therein. Any attempt to
re-invoke dsm_manage with the same workspace will exit with a warning.
To override and re-run dsm_manage, you must either terminate the
existing run and destroy (or rename) the workspace directory, or use
...
take each dataset specification "tree", isolate the "case_extensions"
branch (where the resolution-specific dataset reams and frequencies are
specified), and collect these to create a consolidated unique
"CASE_EXTENSIONS" tree, reducing each dataset_tree to its global
parameters plus a "Case_Extension_ID" in place of the original
extensions. This makes it much easier to edit the branches (reduced form
about 60 to 12) and easier to compare and contrast the major dataset
definitions, and news ones, etc.
...
and to provide the "latest state", necessary for the Data State Machine
to advance required processing.
...
source. The results may then be filtered with "grep" or "cut" for many
applications.
...
If mode is "get", the value of the variable "version" (or "NONE") is
returned. If mode is "set", then "version" is set to vYYYYMMDD (current
UTC date).
