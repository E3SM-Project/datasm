...
is_running=`ps gx | grep "python archive_extraction_service" | grep -v grep | wc -l`

if [ $is_running -eq 0 ]; then
    /p/user_pub/e3sm/bartoletti1/restart_services.sh extraction
fi
