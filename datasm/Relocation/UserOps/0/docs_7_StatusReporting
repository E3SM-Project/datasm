...
To see the status of publication jobs themselves:

    tail -f /p/user_pub/e3sm/staging/publoop/publoop_<latest_date>

and tail -f /p/user_pub/e3sm/staging/publoop/logs/<latest per-dataset logs>
